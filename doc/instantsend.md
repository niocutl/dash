...
This mechanism has been integrated into Bitcore-Node-Ltucoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ltucoinpay/insight-api-ltucoin#web-socket-api](https://github.com/ltucoinpay/insight-api-ltucoin#web-socket-api)
* API: [https://github.com/ltucoinpay/insight-api-ltucoin#instantsend-transactions](https://github.com/ltucoinpay/insight-api-ltucoin#instantsend-transactions)
...
By default, the Ltucoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ltucoin Core daemon:
