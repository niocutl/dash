...
Ltucoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Ltucoin Core, where everyone uses
...
pay attention to for reviewers of Ltucoin Core code.

General Ltucoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Ltucoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
