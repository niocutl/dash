    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ltucoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ltucoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ltucoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Ltucoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ltucoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ltucoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ltucoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ltucoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ltucoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ltucoin Core help message to get a list with possible Ltucoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ltucoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ltucoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Ltucoin Core"); // default title
