...
#define BOOST_TEST_MODULE Ltucoin Test Suite

#include "test_ltucoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_ltucoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
