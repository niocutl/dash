...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LtucoinNetwork") type = LtucoinNetwork;
    if(strType == "LtucoinNetworkVariable") type = LtucoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LtucoinNetwork) s = "LtucoinNetwork";
    if(type == LtucoinNetworkVariable) s = "LtucoinNetworkVariable";
