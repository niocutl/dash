...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Ltucoin Core ltucoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ltucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ltucoin transaction") + "\n" +
              "  ltucoin-tx [options] -create [commands]   " + _("Create hex-encoded ltucoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ltucoin transaction
